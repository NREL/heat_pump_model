...
class electric_heater:
    def __init__(self):
        ...
        self.process_heat_requirement = Q_(np.array([-1.0]*self.n_hrs), 'kW')
        ...
        self.hot_temperature = Q_(np.array([90]*8760), 'degC')
        self.cold_temperature = Q_(np.array([60]*8760), 'degC')
    ...
    '''def initialize_electric_heater(self,sector,process_name):
    ...
    def calculate_energy_and_mass_flow(self):
        ...
        # Calculating the Work into the electric heater
        ...
        if self.print_results: 
            print('Average Power Draw of Electric Heater: {:~.3fP}'.format(self.average_power_in))
            print('Maximum Power Draw of Electric Heater: {:~.3fP}'.format(np.amax(self.power_in)))
    ...
    def write_output(self, filename):
        data = [
            ...
            ['Electric Heater Efficiency', '{:~.3fP}'.format(self.thermal_efficiency)],
